...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    SPIRV_ID = 582,                /* SPIRV_ID  */
    LEFT_OP = 583,                 /* LEFT_OP  */
    RIGHT_OP = 584,                /* RIGHT_OP  */
    INC_OP = 585,                  /* INC_OP  */
    DEC_OP = 586,                  /* DEC_OP  */
    LE_OP = 587,                   /* LE_OP  */
    GE_OP = 588,                   /* GE_OP  */
    ...
    OR_OP = 592,                   /* OR_OP  */
    XOR_OP = 593,                  /* XOR_OP  */
    MUL_ASSIGN = 594,              /* MUL_ASSIGN  */
    DIV_ASSIGN = 595,              /* DIV_ASSIGN  */
    ADD_ASSIGN = 596,              /* ADD_ASSIGN  */
    MOD_ASSIGN = 597,              /* MOD_ASSIGN  */
    LEFT_ASSIGN = 598,             /* LEFT_ASSIGN  */
    RIGHT_ASSIGN = 599,            /* RIGHT_ASSIGN  */
    AND_ASSIGN = 600,              /* AND_ASSIGN  */
    XOR_ASSIGN = 601,              /* XOR_ASSIGN  */
    OR_ASSIGN = 602,               /* OR_ASSIGN  */
    SUB_ASSIGN = 603,              /* SUB_ASSIGN  */
    STRING_LITERAL = 604,          /* STRING_LITERAL  */
    LEFT_PAREN = 605,              /* LEFT_PAREN  */
    RIGHT_PAREN = 606,             /* RIGHT_PAREN  */
    LEFT_BRACKET = 607,            /* LEFT_BRACKET  */
    RIGHT_BRACKET = 608,           /* RIGHT_BRACKET  */
    LEFT_BRACE = 609,              /* LEFT_BRACE  */
    RIGHT_BRACE = 610,             /* RIGHT_BRACE  */
    DOT = 611,                     /* DOT  */
    COMMA = 612,                   /* COMMA  */
    COLON = 613,                   /* COLON  */
    EQUAL = 614,                   /* EQUAL  */
    SEMICOLON = 615,               /* SEMICOLON  */
    BANG = 616,                    /* BANG  */
    DASH = 617,                    /* DASH  */
    TILDE = 618,                   /* TILDE  */
    PLUS = 619,                    /* PLUS  */
    ...
    SLASH = 621,                   /* SLASH  */
    PERCENT = 622,                 /* PERCENT  */
    LEFT_ANGLE = 623,              /* LEFT_ANGLE  */
    RIGHT_ANGLE = 624,             /* RIGHT_ANGLE  */
    VERTICAL_BAR = 625,            /* VERTICAL_BAR  */
    CARET = 626,                   /* CARET  */
    AMPERSAND = 627,               /* AMPERSAND  */
    QUESTION = 628,                /* QUESTION  */
    INVARIANT = 629,               /* INVARIANT  */
    HIGH_PRECISION = 630,          /* HIGH_PRECISION  */
    MEDIUM_PRECISION = 631,        /* MEDIUM_PRECISION  */
    LOW_PRECISION = 632,           /* LOW_PRECISION  */
    PRECISION = 633,               /* PRECISION  */
    PACKED = 634,                  /* PACKED  */
    RESOURCE = 635,                /* RESOURCE  */
    SUPERP = 636,                  /* SUPERP  */
    FLOATCONSTANT = 637,           /* FLOATCONSTANT  */
    INTCONSTANT = 638,             /* INTCONSTANT  */
    UINTCONSTANT = 639,            /* UINTCONSTANT  */
    BOOLCONSTANT = 640,            /* BOOLCONSTANT  */
    IDENTIFIER = 641,              /* IDENTIFIER  */
    TYPE_NAME = 642,               /* TYPE_NAME  */
    CENTROID = 643,                /* CENTROID  */
    IN = 644,                      /* IN  */
    OUT = 645,                     /* OUT  */
    INOUT = 646,                   /* INOUT  */
    STRUCT = 647,                  /* STRUCT  */
    ...
    CASE = 659,                    /* CASE  */
    DEFAULT = 660,                 /* DEFAULT  */
    TERMINATE_INVOCATION = 661,    /* TERMINATE_INVOCATION  */
    TERMINATE_RAY = 662,           /* TERMINATE_RAY  */
    IGNORE_INTERSECTION = 663,     /* IGNORE_INTERSECTION  */
    UNIFORM = 664,                 /* UNIFORM  */
    SHARED = 665,                  /* SHARED  */
    BUFFER = 666,                  /* BUFFER  */
    FLAT = 667,                    /* FLAT  */
    SMOOTH = 668,                  /* SMOOTH  */
    LAYOUT = 669,                  /* LAYOUT  */
    DOUBLECONSTANT = 670,          /* DOUBLECONSTANT  */
    INT16CONSTANT = 671,           /* INT16CONSTANT  */
    UINT16CONSTANT = 672,          /* UINT16CONSTANT  */
    FLOAT16CONSTANT = 673,         /* FLOAT16CONSTANT  */
    INT32CONSTANT = 674,           /* INT32CONSTANT  */
    UINT32CONSTANT = 675,          /* UINT32CONSTANT  */
    INT64CONSTANT = 676,           /* INT64CONSTANT  */
    UINT64CONSTANT = 677,          /* UINT64CONSTANT  */
    SUBROUTINE = 678,              /* SUBROUTINE  */
    DEMOTE = 679,                  /* DEMOTE  */
    PAYLOADNV = 680,               /* PAYLOADNV  */
    PAYLOADINNV = 681,             /* PAYLOADINNV  */
    HITATTRNV = 682,               /* HITATTRNV  */
    CALLDATANV = 683,              /* CALLDATANV  */
    CALLDATAINNV = 684,            /* CALLDATAINNV  */
    PAYLOADEXT = 685,              /* PAYLOADEXT  */
    PAYLOADINEXT = 686,            /* PAYLOADINEXT  */
    HITATTREXT = 687,              /* HITATTREXT  */
    CALLDATAEXT = 688,             /* CALLDATAEXT  */
    CALLDATAINEXT = 689,           /* CALLDATAINEXT  */
    PATCH = 690,                   /* PATCH  */
    SAMPLE = 691,                  /* SAMPLE  */
    NONUNIFORM = 692,              /* NONUNIFORM  */
    COHERENT = 693,                /* COHERENT  */
    VOLATILE = 694,                /* VOLATILE  */
    RESTRICT = 695,                /* RESTRICT  */
    READONLY = 696,                /* READONLY  */
    WRITEONLY = 697,               /* WRITEONLY  */
    DEVICECOHERENT = 698,          /* DEVICECOHERENT  */
    QUEUEFAMILYCOHERENT = 699,     /* QUEUEFAMILYCOHERENT  */
    WORKGROUPCOHERENT = 700,       /* WORKGROUPCOHERENT  */
    SUBGROUPCOHERENT = 701,        /* SUBGROUPCOHERENT  */
    NONPRIVATE = 702,              /* NONPRIVATE  */
    SHADERCALLCOHERENT = 703,      /* SHADERCALLCOHERENT  */
    NOPERSPECTIVE = 704,           /* NOPERSPECTIVE  */
    EXPLICITINTERPAMD = 705,       /* EXPLICITINTERPAMD  */
